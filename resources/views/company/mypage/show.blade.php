                    ...
                    <div class="container px-5 py-4 mx-auto">
                      ...
                      <x-auth-validation-errors class="mb-4" :errors="$errors" />
                        <div class="lg md:w-2/3 mx-auto">
                          ...
                          <button type="button" onclick="location.href='{{ route('company.company.edit', ['company' => $company->id ]) }}'" class="bg-blue-300 border-0 py-2 px-8 focus:outline-none hover:bg-blue-400 rounded text-lg">編集</button>
                          ...
                          <form id="delete_{{$company->id}}" method="post" action="{{ route('company.company.destroy', ['company' => $company->id])}}">
                            @csrf 
                            @method('delete')
