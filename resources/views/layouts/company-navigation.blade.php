    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('company.jobs.create')"
                        :active="request()->routeIs('company.jobs.create')">
                        求人登録
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('company.company.show', ['company' => Auth::id()])"
                        :active="request()->routeIs('company.company.show')">
                        企業情報
                    </x-nav-link>
                </div>
            </div>
