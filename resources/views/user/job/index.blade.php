                            ...
                            @if ($prefectures)
                                @foreach ($prefectures as $prefecture)
                                    <li class="flex items-center p-2 pl-11 w-full ">
                                        <input type="checkbox" value="{{ $prefecture->id }}" class="mr-2">
                                        <label
                                            class="text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">{{ $prefecture->prefecture }}</label>
                                    </li>
                                @endforeach
                            @endif
                        </ul>
                    ...
                    <li>
                        ...
                        <ul id="dropdown-salary" class="hidden py-2 space-y-2">
                            <li class="flex items-center p-2 pl-11 w-full ">
                                ...
                                <label
                                    class="text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">サンプル１</label>
                            </li>
                            <li class="flex items-center p-2 pl-11 w-full ">
                                <input type="checkbox" value="" class="mr-2">
                                <label
                                    class="text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">サンプル2</label>
                            </li>
                        </ul>
